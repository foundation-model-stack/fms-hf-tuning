...
A framework for controlling the trainer loop using user-defined rules and metrics.
...
![High-Level Design Diagram: Trainer Controller Framework](../../architecture_records/imgs/001-arch.png)

## Usage and customization
We added a new trainer callback (see [here](https://huggingface.co/docs/transformers/v4.37.2/en/main_classes/callback)) which accepts a `training control definition` YAML file containing:
...
1. `_` could be used in the case of key names, and name of the metric, operation or controller. This is usually to break multiple words of a name phrase.
