...
from .pytorch_utils import ALL_LAYERNORM_LAYERS, is_torch_greater_or_equal_than_2_3
...
class Trainer:
        ...
        **kwargs,
        ...
        if resume_from_checkpoint is not None:
            if (
                ...
                and not (self.is_fsdp_enabled or self.is_fsdp2_enabled)
            ):
    ...
    def _inner_training_loop(
        ...
        if use_accelerator_prepare and (self.is_fsdp_enabled or self.is_fsdp2_enabled):
