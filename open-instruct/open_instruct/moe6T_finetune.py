...
from open_instruct.model_utils import push_folder_to_hub, save_with_accelerate, save_state, save_with_accelerate_for_moe_kernels
...
from tuning.config.acceleration_configs.acceleration_framework_config import AccelerationFrameworkConfig
from tuning.config.acceleration_configs.fast_moe import (
    FastMoeConfig,
    FastMoe,
)
...
def main(args: FlatArguments, tc: TokenizerConfig):
                    ...
                    if completed_steps % checkpointing_steps == 0:
                        ...
                        if accelerator.is_local_main_process:
                            if fast_moe_config is not None:
                                ...
                                recover_safetensors_from_dcp(output_dir, args.model_name_or_path, converted, is_deepspeed=True)
    ...
    if args.output_dir is not None:
        ...
        if fast_moe_config is None:
            ...
            logger.info("skipping save since you can use checkpoint from last step")
        # else:
