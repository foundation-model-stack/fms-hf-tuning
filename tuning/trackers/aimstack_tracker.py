        ...
        try:
            ...
            if self.hash_export_path:
                with open(self.hash_export_path, "w", encoding="json") as f:
                    f.write('{"run_hash":"' + str(self.experiment.hash) + '"}\n')
...
class AimStackTracker(Tracker):
    def __init__(self, tracker_config: AimConfig, logger=None):
        super().__init__(name="aim", tracker_config=tracker_config, logger=logger)
