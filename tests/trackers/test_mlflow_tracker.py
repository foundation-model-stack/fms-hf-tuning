...
def test_run_with_mlflow_tracker_name_but_no_args():
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        with pytest.raises(
            ...
            sft_trainer.train(copy.deepcopy(MODEL_ARGS), copy.deepcopy(DATA_ARGS), train_args)
...
def test_e2e_run_with_mlflow_tracker():
    ...
    sft_trainer.train(
        copy.deepcopy(MODEL_ARGS), copy.deepcopy(DATA_ARGS), train_args, tracker_configs=tracker_configs
    )
